...
export function TaskList() {
    ...
    const [taskSituation, setTaskSituation] = useState<String>('to-do')
            ...
            <List>
                {tasks?.map(task => (
                    <>
                        ...
                        <div>
                            {!task.done &&
                                <Select name="situation" onChange={ (e)=> handlechangeList(e.target.value, task.id) } >
                                    <option value='to-do' selected> situação </option>
                                    <option value='for-later'> Para Depois </option>
                                    <option value='priority'> Prioridade </option>
                                </Select>
                            }
                            <img src={Delete} alt="delete" onClick={() => deleteTask(task.id)} />
                        </div>
